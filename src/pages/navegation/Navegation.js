...
function Navegation({ toogleSummer }) {
  ...
  const { isSummer, setDestinations, setIsSummer, tours } = useContext(
    MyContext
  );
  ...
  useEffect(() => {
    ...
    setAllActivities(
      activitie
        .filter((v, i) => activitie.indexOf(v) === i)
        ...
        <div className="navegation--center-opendiv-summer">
          {link === "destination" ? (
            <div>
              {allPlaces.map((e, i) => (
                <div
                  onClick={() => handlePlace(e)}
                  key={i}
                  className={
                    isSummer
                      ? "navegation--center-links-summer"
                      : "navegation--center-links-winter"
                  }
                >
