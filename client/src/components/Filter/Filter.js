 ...
 */
    const handleOnClick=()=>{
      ...
      if(activities && !place)  setDestinations({type:'SELECTED_DESTINATIONS',destinations:data.filter(e=> e.activities===activities)})
      if(!activities && !place)  setDestinations({type:'SELECTED_DESTINATIONS',destinations:data})
    }
